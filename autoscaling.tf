...
resource "aws_autoscaling_group" "frontend-asg" {
  ...
  max_size           = 1
  min_size           = 1
  vpc_zone_identifier = [aws_subnet.private-sub-front-3a.id, aws_subnet.private-subnet-front-4b.id]
...
resource "aws_autoscaling_group" "backend-asg" {
  ...
  max_size           = 1
  min_size           = 1
  vpc_zone_identifier = [aws_subnet.private-subnet-back-5a.id, aws_subnet.private-subnet-back-6b.id]
